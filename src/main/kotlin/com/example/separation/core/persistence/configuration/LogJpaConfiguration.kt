...
import com.example.separation.core.persistence.configuration.LogJpaConfiguration.Companion.BASE_PACKAGE
import com.example.separation.core.persistence.configuration.LogJpaConfiguration.Companion.ENTITY_MANAGER_FACTORY
import com.example.separation.core.persistence.configuration.LogJpaConfiguration.Companion.TRANSACTION_MANAGER
...
@EnableJpaRepositories(
    ...
    includeFilters = [ComponentScan.Filter(LogRepository::class)],
    entityManagerFactoryRef = ENTITY_MANAGER_FACTORY,
    transactionManagerRef = TRANSACTION_MANAGER
)
class LogJpaConfiguration : MultipleDatabase() {

    companion object {
        const val BASE_PACKAGE = "com.example.separation"
        private val ENTITY_ANNOTATION = LogEntity::class.java
        private const val COMPONENT_NAME = "log"
